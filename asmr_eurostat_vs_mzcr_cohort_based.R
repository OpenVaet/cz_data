...
#   from outputs/weekly_death_rates_from_download.csv
...
# -------------------------------------------------------------------
first_out_file <- "outputs/weekly_asmr_from_download.csv"
...
# -------------------------------------------------------------------
weekly_pop_file <- "outputs/weekly_death_rates_from_download.csv"
...
g <- ggplot(asmr_win_long, aes(x = iso_date, y = asmr_per_100k_year,
  ...
  labs(
    ...
    caption = paste(
      ...
      "Population: weekly reference (total_unvaccinated + total_vaccinated) from outputs/weekly_death_rates_from_download.csv.",
